...
The project is deployed on **Vercel**. Every push to the main branch can trigger an automatic deployment.
...
**© 2026 Nexo Store — Developed by Eng. Saif El-Deen**
